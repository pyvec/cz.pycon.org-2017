...
gulp.task('runserver', function(){
  exec('python manage.py runserver --settings=pyconcz_2017.settings.local', function(err, stdout, stderr){
    console.log(stdout);
    console.log(stderr);
  });
});
...
gulp.task('compile-css', ['clean-css'], function(){
  return gulp
    ...
    .pipe(gulp.dest('./pyconcz_2017/static/css/')) // resulting CSS
